    ...
    <View style={styles.playListContainer}>
      <Stack.Screen
        options={{
          headerTitle: '',
          headerLeft: () => (
            <LeftHeader text="Genres" navigation={'(tabs)/library'} />
          ),
      ...
      />
      <Text style={styles.text1style}>Genres</Text>
      <SongScreenSearchComponent text={'   Find in Genres'} />

      <Link href="/library_screens/genreprofile" asChild>
        <TouchableOpacity>
          <View style={styles.buttonStyle}>
            <Text style={styles.Text2Style}>Afrobeats</Text>
